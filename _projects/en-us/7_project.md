...
The site was built entirely through conversations with **[Claude Code](https://claude.ai/code)** (Anthropic's AI coding assistant) — not written by the lab members themselves. Claude Code handled everything from layout customization and CSS fixes to adding new pages, bibliography management, and blog posts. If you'd like to build something similar, the source code is a good starting point and Claude Code can do the rest.
...
- Publications list powered by [jekyll-scholar](https://github.com/inukshuk/jekyll-scholar) with BibTeX source
- Responsive design with dark/light mode
- Blog with thumbnail card display on the top page
